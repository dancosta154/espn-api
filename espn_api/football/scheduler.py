...
def parse_cmd():
    parser = argparse.ArgumentParser(
        description="Generates schedule for a league with divisional play"
    )

    parser.add_argument(
        "--div1", nargs="+", metavar="TEAM", help="Teams for first division",
    )

    parser.add_argument(
        "--div2", nargs="+", metavar="TEAM", help="Teams for second division",
    )
